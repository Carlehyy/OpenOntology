        ...
        {editing ? (
          <form className="space-y-4">
            ...
            <div>
              ...
              <textarea {...register('description')} rows={2} className="w-full border border-border rounded-lg px-3 py-2 text-sm resize-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring" />
            </div>
            <div>
              <label className="block text-xs text-muted-foreground mb-1">执行规则</label>
              <textarea {...register('execution_rule')} rows={2} className="w-full border border-border rounded-lg px-3 py-2 text-sm resize-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring" />
            </div>
            <div>
              <label className="block text-xs text-muted-foreground mb-1">函数代码</label>
              <textarea {...register('function_code')} rows={6} className="w-full border border-border rounded-lg px-3 py-2 text-sm font-mono resize-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring" />
            </div>
          </form>
        ) : (
