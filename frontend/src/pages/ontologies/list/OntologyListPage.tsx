      ...
      <div className="space-y-5">
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <Input
            ...
            className="selection:bg-brand-mist selection:text-brand-ink focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-ring"
          />
          <div>
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full resize-none rounded-md border border-[var(--color-border)] bg-card px-3 py-2 text-sm text-[var(--color-text-primary)] placeholder:text-[var(--color-text-tertiary)] selection:bg-brand-mist selection:text-brand-ink focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
          />
    ...
    <div className="min-h-full">
      <section className="mb-4 flex flex-wrap items-center gap-3 rounded-xl border border-border bg-card px-4 py-3 shadow-sm/50" aria-label="本体筛选">
        ...
        >
          ...
          <SelectTrigger
            aria-label="按所属领域筛选"
            className="h-9 w-44 rounded-lg border-border bg-card text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-ring"
          >
            <SelectValue />
          </SelectTrigger>
          <SelectContent>
