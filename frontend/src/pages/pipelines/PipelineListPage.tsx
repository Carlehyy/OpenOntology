      ...
      <div className="flex flex-wrap items-center gap-3 rounded-2xl border border-border bg-card px-4 py-3 xl:flex-nowrap">
        <div className="relative w-full sm:w-64 xl:w-72 xl:flex-none">
          ...
          <input
            ...
            placeholder="搜索名称 / ID..."
            className="w-full rounded-xl border border-border py-2 pl-8 pr-3 text-sm outline-none transition focus-visible:ring-2 focus-visible:ring-ring"
          />
          {search && (
        ...
        <div className="space-y-3">
          ...
          <div>
            ...
            <input
              ...
              className="w-full border rounded-lg px-3 py-2 text-sm focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none transition-colors"
