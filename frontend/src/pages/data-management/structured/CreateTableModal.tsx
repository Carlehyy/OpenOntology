            ...
            <>
              <section className="border-b border-border px-5 py-4">
                ...
                <input value={name} onChange={event => setName(event.target.value)} placeholder="例如：设备台账"
                  className="h-9 w-full rounded-lg border border-border px-3 text-sm outline-none transition focus-visible:ring-2 focus-visible:ring-ring" />
              </section>
