...
export function ContextUsage({ messages, model }: { messages: SuperMessage[]; model?: ModelConfig }) {
  ...
  return (
    <aside
      ...
      className="flex h-9 w-40 shrink-0 cursor-default flex-col justify-center rounded-lg border border-brand-line bg-[var(--color-context-usage-bg)] px-2.5 shadow-[inset_0_0_0_1px_rgba(255,255,255,0.55)] transition-colors hover:border-brand xl:w-48"
    >
