          ...
          <div id="browser-source-drawer" ref={sourceDrawerRef} role="dialog"
            ...
            <div className="p-4">
              ...
              <div className="mt-3 grid gap-2">
                <input value={sourceName} onChange={event => setSourceName(event.target.value)} placeholder="来源名称" className="h-8 rounded-lg border bg-card px-3 text-xs outline-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring" />
                {sourceType === 'remote_cdp' && <>
                  <input value={endpointUrl} onChange={event => setEndpointUrl(event.target.value)} placeholder="https://browser.example.com/cdp" className="h-8 rounded-lg border bg-card px-3 font-mono text-xs outline-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring" />
                  <textarea value={headerJson} onChange={event => setHeaderJson(event.target.value)} placeholder='{"Authorization":"Bearer …"}' className="h-16 resize-none rounded-lg border bg-card p-2 font-mono text-[11px] outline-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring" />
                </>}
