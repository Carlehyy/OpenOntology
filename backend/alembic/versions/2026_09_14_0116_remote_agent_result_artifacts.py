...
Revision ID: 0116_remote_agent_result_artifacts
Revises: 0115_reconcile_outbox_payload
"""
from alembic import op
import sqlalchemy as sa
from sqlalchemy import inspect as sa_inspect

revision = "0116_remote_agent_result_artifacts"
down_revision = "0115_reconcile_outbox_payload"
branch_labels = None
depends_on = None
